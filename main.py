...
from table.table import Base, CricketerProfile, Ranking, RunRateTable, Runs
...
# Cricketer Profile
@app.post('/create-new_cricketer', status_code=status.HTTP_201_CREATED)
...
@app.get('/country_players/{country_name}', status_code=status.HTTP_200_OK)
...
@app.post("/ranking/{player}", status_code=status.HTTP_201_CREATED)
...
@app.get("/top-odi/{ranking}", status_code=status.HTTP_200_OK, response_model=List[str])
...
@app.post('/runrate/{player_id}', status_code=status.HTTP_201_CREATED)
...
@app.get("/strike_rate/{strike_rate}", status_code=status.HTTP_200_OK, response_model=List[StrikeRateResponse])
...
@app.delete("/delete_strike_rate/{id}", status_code=status.HTTP_200_OK)
...
@app.post("/run/{player_id}", status_code=status.HTTP_201_CREATED)
...
@app.get('/highest_odi/{runing}', status_code=status.HTTP_200_OK, response_model=List[ODI])
